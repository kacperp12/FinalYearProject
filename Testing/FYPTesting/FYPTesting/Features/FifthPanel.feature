...
#Clicking on all available input types displays correct graphics (e.g.: label above text box displays correctly)
#Input validation for all input types (valid + invalid)
#Correct submission displays a new entry in the gridbox (try figure out why first input is ignored. Play around with the function that resets submit button.)
