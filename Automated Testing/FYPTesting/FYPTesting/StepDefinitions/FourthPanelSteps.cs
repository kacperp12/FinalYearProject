...
namespace FYPTesting.StepDefinitions
{
    ...
    public class FourthPanelSteps
    {
        ...
        public void ShapeDisplayed(string shapeName)
        {
        ...
        public void NumEdgesDisplayed(int numEdges)
        { 
        ...
        public void SelectEdgeAndColour(string selectedEdge, string selectedCol)
        {
        ...
        public void IsEdgeColourChanged(string selectedEdge, string shapeName, string selectedColour)
        {
