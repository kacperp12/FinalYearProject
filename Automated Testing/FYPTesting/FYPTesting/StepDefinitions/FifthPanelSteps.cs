...
namespace FYPTesting.StepDefinitions
{
    ...
    public class FifthPanelSteps
    {
        ...
        public void SelectFromInputTypes(string inputType)
        {
        ...
        public void LabeldDislayedAboveTextbox(string inputType)
        {
        ...
        public void InputIntoTextbox(string inputString)
        {
        ...
        public void NewEntryInGridbox(string inputType)
        {
